// DeepLabV3+ CNN segmentation visualization utilities
// Maps land cover class predictions to visual representations

import { LAND_COVER_CLASSES } from '../constants/land-cover-classes'
import type { SegmentationOverlay } from '../types'
