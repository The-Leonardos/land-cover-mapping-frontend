    ...
    <table className="w-full text-xs min-w-[440px]">
      <thead>
        <tr className="border-b border-border bg-muted/50">
          <th className="py-2 px-3"><div className="h-4 w-12 bg-muted rounded animate-pulse" /></th>
          <th className="py-2 px-3"><div className="h-5 w-14 bg-muted rounded mx-auto animate-pulse" /></th>
          <th className="py-2 px-3"><div className="h-5 w-14 bg-muted rounded mx-auto animate-pulse" /></th>
          <th className="py-2 px-3"><div className="h-4 w-14 bg-muted rounded mx-auto animate-pulse" /></th>
        </tr>
      </thead>
