...
//             <p className="text-xs text-muted-foreground">Built-up</p>
...
//               </div>
//               {selectedBarangay && (
//                 <div className="text-xs md:text-xs text-muted-foreground bg-muted/50 dark:bg-black/30 px-2 md:px-3 py-1 rounded-full">
